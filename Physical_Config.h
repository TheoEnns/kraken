...
const SEGMENT3D hipSegment[CNT_LEGS] =
    {
        {{ 47.625f, 82.489f, 32.25f}, (90.0f)*M_PI/180.0f,   (30.0f)*M_PI/180.0f,   (60.0f)*M_PI/180.0f  },
        {{-47.625f, 82.489f, 32.25f}, (150.0f)*M_PI/180.0f,  (90.0f)*M_PI/180.0f,   (120.0f)*M_PI/180.0f },
        {{-95.25f,  0.0f,    32.25f}, (-150.0f)*M_PI/180.0f, (150.0f)*M_PI/180.0f,  (180.0f)*M_PI/180.0f },
        {{-47.625f,-82.489f, 32.25f}, (-90.0f)*M_PI/180.0f,  (-150.0f)*M_PI/180.0f, (240.0f)*M_PI/180.0f },
        {{ 47.625f,-82.489f, 32.25f}, (-30.0f)*M_PI/180.0f,  (-90.0f)*M_PI/180.0f,  (300.0f)*M_PI/180.0f },
        {{ 95.25f,  0.0f,    32.25f}, (30.0f)*M_PI/180.0f,   (-30.0f)*M_PI/180.0f,  (0.0f)*M_PI/180.0f   },
    };
...
const SEGMENT3D tibiaSegment =
        {{ 34.429f, -131.0f, 0.0f},    (90.0f)*M_PI/180.0f,   (-90.0f)*M_PI/180.0f,    0.0f};
...
const SEGMENT3D* segmentTemplates[NUM_JOINTS] =
    {
        &coxaSegment,
        &femurSegment,
        &tibiaSegment,
